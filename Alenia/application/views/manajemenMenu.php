            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center><?php echo $mn->nama_outfit; ?></center></td>
                  <td><center><?php echo $mn->type; ?></center></td>
                  <td><center><?php echo $mn->deskripsi; ?></center></td>
                  ...
                  <td>
                    ...
                    <div class="modal fade" id="modal<?php echo $mn->kd_menu; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Menu - <?php echo $mn->nama_outfit; ?></h5>
                          ...
                          <div class="modal-body">
                              <div class="form-group">
                                ...
                                <br>
                                <input id="nama_outfit" type="text" class="form-control" name="nama_outfit" value="<?php echo $mn->nama_outfit; ?>" readonly>
                                ...
                                <br>
                                <input id="deskripsi" type="text" class="form-control" name="deskripsi" value="<?php echo $mn->deskripsi; ?>" readonly>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="form-group">
                ...
                <br>
                <input id="nama_outfit" type="text" class="form-control" name="nama_outfit" required="" oninvalid="this.setCustomValidity('Nama Menu Harus Diisi!')" oninput="this.setCustomValidity('')">
                ...
                <br>
                <input id="deskripsi" type="text" class="form-control" name="deskripsi" required="" oninvalid="this.setCustomValidity('Isi deskripsi')" oninput="this.setCustomValidity('')">
