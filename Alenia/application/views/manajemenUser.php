<?php
include 'koneksi.php';
$get1 = mysqli_query($koneksi, "select * from user where level ='admin'");
    ...
    <table id="datatable" class="table table-striped table-bordered">
      ...
      <tbody>
        <?php foreach ($user as $mn) : ?>
          <tr>
            <th scope="row">
              <center><?php echo $mn->id_user; ?></center>
            </th>
            <td>
              <center><?php echo $mn->username; ?></center>
            </td>
            <td>
              <center><?php echo $mn->level; ?></center>
            </td>
            <td>
              <center>
