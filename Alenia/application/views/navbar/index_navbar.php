...
<html lang="en">
  <head>
    ...
    <title><?php echo $title; ?> | Alenia </title>
  </head>
  <body>
<!-- Start Sidebar -->
<nav class="navbar navbar-expand-md navbar-dark bg-secondary" style="">
  <a class="navbar-brand" href="#" style="margin-left: 2%;">
    <img src="<?php echo base_url() ?>assets/img/alenia.png" width="30" height="35" class="d-inline-block align-top" alt="">
    <span class="menu-collapsed" >
		<b>lenia</b>
	</span>
  </a>

  <a href="<?php echo base_url().'Login_controller/logout'?>" style="color: white; margin-left: 81%;"><i class="fa fa-sign-out-alt fa-2x"></i></a>
        ...
        <ul class="list-group">
            ...
            <a href="<?php echo base_url().'Index_controller'?>" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" style="margin-left: -5%;">
                    <span class="fas fa-tachometer-alt mr-3"></span>
                    <span class="menu-collapsed"><img src=""><b>Dashboard</b></span>
                </div>
            </a>
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                <a href="<?php echo base_url().'Pakaian_controller'?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="fas fa-tshirt"></span>
                    <span class="menu-collapsed" style="margin-left: 5%;">Pakaian</span>
                </a>
                <a href="<?php echo base_url().'Sepatu_controller'?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="fas fa-shoe-prints"></span>
                    <span class="menu-collapsed" style="margin-left: 5%;">Sepatu</span>
                </a> 
                <a href="<?php echo base_url().'Tas_controller'?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="fas fa-shopping-bag" style="margin-left: 2%;"></span>
                    <span class="menu-collapsed" style="margin-left: 8%;">Tas</span>
                </a>
            </div>
