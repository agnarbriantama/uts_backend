...
<html lang="en">
  ...
  <form class="form-signin" method="POST" action="<?php echo base_url().'Register_controller/register'?>">
    ...
    <div class="form-label-group">
      <input type="password" name="retype" class="form-control" placeholder="Masukkan Password Anda!" required>
    ...
    <div class="custom-control custom-checkbox" style="margin-top: -10px;">
        ...
        <div class="form-group">
          ...
          <a href="<?php echo base_url().'Login_controller'?>">Sudah punya akun?</a>
        </div>

    <button type="submit" class="btn btn-primary btn-block" name="login">Registrasi</button>
    ...
    <!--<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="">
      <a class="navbar-brand" href="#" style="margin-left: 45%;">
        <img src="<?php echo base_url() ?>assets/img/alenia.png" width="30" height="30" class="d-inline-block align-top" alt="">
     ...
     End Sidebar 
    <div class="row">
      <div class="col-sm-9"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYHd4nhm7Ji3L0DMrHi3dYJ9_x0X_3zM4qkQ&usqp=CAU" style="width: 100%;"></div>
        <div class="col-sm-3" style="background-color: grey; margin-left: -1%;">
          <br>
