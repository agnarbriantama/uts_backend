          ...
          <div class="modal-body">
            <form method="POST" class="form-index" action="<?php echo base_url().'Transaksi_controller/inputPembayaran'?>">
              <div class="form-group">
                ...
                <br>
                <input type="text" class="form-control" id="customer" name="customer" autocomplete = "off" required="" oninvalid="this.setCustomValidity('Customer Harus Diisi!')" oninput="this.setCustomValidity('')">
                ...
                <br>
                <input type="text" class="form-control" id="no_meja" autocomplete = "off" name="no_meja" required="" oninvalid="this.setCustomValidity('Nomor HP Harus Diisi!')" oninput="this.setCustomValidity('')">
